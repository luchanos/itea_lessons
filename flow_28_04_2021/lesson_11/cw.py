...
# 1. добавить наш модуль в саму папку со всеми остальными модулями в venv (это лютый костыль-костылищще)
...
# from some_directory import my_shiny_func
# from some_directory.some_file_1 import my_shiny_func
from flow_28_04_2021.lesson_4.cw_live import *  # две точки - на две директории выше
# my_shiny_func()
